...
classes = ['Bacteria', 'Lactobacillus', 'Micrococcus', 'Virus']
...
def upload1():
    ...
    if request.method=='POST':
        ...
        new_model = load_model(r"visualizations/FinalModel.h5")
        ...
        if prediction=='Bacteria':
            msg='Diseases caused by Bacteria are: Bubonic plague, Malaria '
        elif prediction=='Lactobacillus':
            msg='Diseases caused by Lactobacillus are: infections such as endocarditis,intra-abdominal abscesses including liver abscess'
        elif prediction=='Micrococcus':
            msg='Diseases caused by Micrococcus are:pneumonia, endophthalmitis, keratolysis'
        else:
            msg='Diseases caused by Virus:Chickenpox, Flu, Human papillomavirus'
